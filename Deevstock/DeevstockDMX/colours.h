...
DEFINE_GRADIENT_PALETTE( pinks_p ) {
  0,   255,  0,  0,
  64,   244, 66, 220,
  128,   255,  0,  0,
  255,   255, 255, 255
...
DEFINE_GRADIENT_PALETTE( temperature_gp ) {
  ...
  DEFINE_GRADIENT_PALETTE( Aurora2_gp ) {
...
DEFINE_GRADIENT_PALETTE( retro_clown_gp ) {
    0, 227,101,  3,
  117, 194, 18, 19,
  255,  92,  8,192};
...
DEFINE_GRADIENT_PALETTE( toxy_reaf_gp ) {
    0,   1,221, 53,
  255,  73,  3,178};
...
DEFINE_GRADIENT_PALETTE( semi_blue_gp ) {
    0,   0,  0,  0,
   12,   1,  1,  3,
   53,   8,  1, 22,
   80,   4,  6, 89,
...
DEFINE_GRADIENT_PALETTE( red_reaf_gp ) {
    0,   3, 13, 43,
  104,  78,141,240,
  188, 255,  0,  0,
  255,  28,  1,  1};
...
DEFINE_GRADIENT_PALETTE( yelblu_hot_gp ) {
    0,   4,  2,  9,
   58,  16,  0, 47,
  122,  24,  0, 16,
  158, 144,  9,  1,
...
DEFINE_GRADIENT_PALETTE( lite_light_gp ) {
    0,   0,  0,  0,
    9,   1,  1,  1,
   40,   5,  5,  6,
   66,   5,  5,  6,
...
DEFINE_GRADIENT_PALETTE( red_flash_gp ) {
    0,   0,  0,  0,
   99, 227,  1,  1,
  130, 249,199, 95,
  155, 227,  1,  1,
...
DEFINE_GRADIENT_PALETTE( blink_red_gp ) {
    0,   1,  1,  1,
   43,   4,  1, 11,
   76,  10,  1,  3,
  109, 161,  4, 29,
...
DEFINE_GRADIENT_PALETTE( red_shift_gp ) {
    0,  31,  1, 27,
   45,  34,  1, 16,
   99, 137,  5,  9,
  132, 213,128, 10,
...
DEFINE_GRADIENT_PALETTE( red_tide_gp ) {
    0, 247,  5,  0,
   28, 255, 67,  1,
   43, 234, 88, 11,
   58, 234,176, 51,
...
DEFINE_GRADIENT_PALETTE( candy2_gp ) {
    0,  39, 33, 34,
   25,   4,  6, 15,
   48,  49, 29, 22,
   73, 224,173,  1,
...
CRGB getCRGBForBand(int x, int pal) {
  ...
  if(pal == 1) { // bit hacky to use palette id here, but don't want to litter the code with lots of different methods. TODO: add enum for palette creation type
    ...
    hsv = CHSV(MSGEQ7get(b), 255, map(MSGEQ7get(b), 0, 255, 30, 255));  // pick hue
...
PaletteAndNameList palettes = { {RainbowColors_p, "RainbowColors"}, {audio_responsive_gp, "audio_responsive"}, {audio_responsive_gp, "audio_responsive"}, {audio_responsive_gp, "audio_responsive"}, {RainbowStripeColors_p, "RainbowStripeColors"}, {CloudColors_p, "CloudColors"}, {PartyColors_p, "PartyColors"}, {pinks_p, "pinks"}, {pinkPurple_p, "pinkPurple"}, {greenBlue_p, "greenBlue"}, {greenBlueYellow_p, "greenBlueYellow"}, {ib_jul01_gp, "ib_jul01"}, {es_vintage_57_gp, "es_vintage_57"}, {es_vintage_01_gp, "es_vintage_01"}, {es_rivendell_15_gp, "es_rivendell_15"}, {rgi_15_gp, "rgi_15"}, {retro2_16_gp, "retro2_16"}, {Analogous_1_gp, "Analogous_1"}, {es_pinksplash_08_gp, "es_pinksplash_08"}, {es_ocean_breeze_036_gp, "es_ocean_breeze_036"}, {departure_gp, "departure"}, {es_landscape_64_gp, "es_landscape_64"}, {es_landscape_33_gp, "es_landscape_33"}, {rainbowsherbet_gp, "rainbowsherbet"}, {gr65_hult_gp, "gr65_hult"}, {gr64_hult_gp, "gr64_hult"}, {GMT_drywet_gp, "GMT_drywet"}, {ib15_gp, "ib15"}, {Tertiary_01_gp, "Tertiary_01"}, {lava_gp, "lava"}, {fierce_ice_gp, "fierce_ice"}, {Colorfull_gp, "Colorfull"}, {Pink_Purple_gp, "Pink_Purple"}, {Sunset_Real_gp, "Sunset_Real"}, {Sunset_Yellow_gp, "Sunset_Yellow"}, {Beech_gp, "Beech"}, {Another_Sunset_gp, "Another_Sunset"}, {es_autumn_19_gp, "es_autumn_19"}, {BlacK_Blue_Magenta_White_gp, "BlacK_Blue_Magenta_White"}, {BlacK_Magenta_Red_gp, "BlacK_Magenta_Red"}, {BlacK_Red_Magenta_Yellow_gp, "BlacK_Red_Magenta_Yellow"}, {Blue_Cyan_Yellow_gp, "Blue_Cyan_Yellow"}, {Orange_Teal_gp, "Orange_Teal"}, {Tiamat_gp, "Tiamat"}, {April_Night_gp, "April_Night"}, {Orangery_gp, "Orangery"}, {C9_gp, "C9"}, {Sakura_gp, "Sakura"}, {Aurora_gp, "Aurora"}, {Atlantica_gp, "Atlantica"}, {C9_2_gp, "C9_2"}, {C9_new_gp, "C9_new"}, {temperature_gp, "temperature"}, {Aurora2_gp, "Aurora2"}, {retro_clown_gp, "retro_clown"}, {candy_gp, "candy"}, {toxy_reaf_gp, "toxy_reaf"}, {fairy_reaf_gp, "fairy_reaf"}, {semi_blue_gp, "semi_blue"}, {pink_candy_gp, "pink_candy"}, {red_reaf_gp, "red_reaf"}, {aqua_flash_gp, "aqua_flash"}, {yelblu_hot_gp, "yelblu_hot"}, {lite_light_gp, "lite_light"}, {red_flash_gp, "red_flash"}, {blink_red_gp, "blink_red"}, {red_shift_gp, "red_shift"}, {red_tide_gp, "red_tide"}, {candy2_gp, "candy2"} };